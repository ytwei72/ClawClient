...
import type { InternalContentType, InternalMessageStatus, NotificationType, ReqIdentifier, AllowType, ApplicationHandleResult, GroupAtType, GroupJoinSource, GroupMemberRole, GroupStatus, GroupType, GroupVerificationType, MessageReceiveOptType, MessageStatus, MessageType, OnlineState, Platform, SessionType } from './enum';
export interface HttpRequest {
    reqFuncName: RequestApi | InternalRequestApi;
    replaceURL?: string;
    data: unknown;
    operationID: string;
}
...
export interface GeneralWsResp {
    reqIdentifier: ReqIdentifier;
    errCode: number;
    errMsg: string;
    msgIncr: string;
...
export interface SDKMessage {
    ...
    recvID: string;
    msgFrom: number;
    contentType: InternalContentType | NotificationType;
    ...
    offlinePush: SdkWsProto.OfflinePushInfo;
    attachedInfo: string;
    ex: string;
    localEx: string;
}
